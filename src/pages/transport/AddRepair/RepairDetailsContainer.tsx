...
function RepairDetailsContainer({ formData, setFormData, academicYear }: any) {
            ...
            <input
              ...
              onChange={(e: any) => {
                setFormData({
                  ...
                  total_amount:
                    parseInt(e.target.value) + parseInt(formData.tax),
                });
              }}
              required
              // defaultValue={academicYearOptions.filter(
            ...
            <input
              ...
              onChange={(e: any) => {
                setFormData({
                  ...
                  tax: e.target.value,
                  total_amount:
                    parseInt(e.target.value) + parseInt(formData.amount),
                });
              }}
              required
              // defaultValue={academicYearOptions.filter(
