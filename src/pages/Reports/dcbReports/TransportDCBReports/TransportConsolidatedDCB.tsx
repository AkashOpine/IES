...
function TransportConsolidatedDCB() {
  ...
  useEffect(() => {
    console.log(
      ...
      transportDetailReport?.transportConsolidatedDcb
    );
  }, [transportDetailReport]);
  ...
  const onGridReady = useCallback(
    (params: any) => {
      return transportDetailReport.transportConsolidatedDcb;
    },
    [transportDetailReport.transportConsolidatedDcb]
  );
  useEffect(() => {}, [transportDetailReport.transportConsolidatedDcb]);
  const footerData = [
    transportDetailReport.transportConsolidatedDcb?.grand_total,
  ]?.map((footerRow) => {
    return {
      totalLabel: "Total",
      ...transportDetailReport.transportConsolidatedDcb?.heads?.reduce(
            ...
            <div className="ag-theme-alpine grid-table">
              <div className="btn-export">
                <button
                  onClick={() =>
                    onBtExport(
                      transportDetailReport?.transportConsolidatedDcbExcel
                    )
                  }
                  disabled={
                    transportDetailReport?.transportConsolidatedDcbExcel === ""
              ...
              <AgGridReact
                ref={gridRef}
                // rowData={transportDetailReport.transportConsolidatedDcb}
                // columnDefs={columnDefs}
                columnDefs={transportDetailReport.transportConsolidatedDcb?.header?.map(
                  (heading: string, index: number) => ({
                    headerName: heading,
                    field:
                      transportDetailReport.transportConsolidatedDcb?.heads[
                        index
                      ],
                  })
                )}
                rowData={
                  transportDetailReport.transportConsolidatedDcb?.result
                    ? transportDetailReport.transportConsolidatedDcb?.result
                    : []
                }
                animateRows={true}
...
export default TransportConsolidatedDCB