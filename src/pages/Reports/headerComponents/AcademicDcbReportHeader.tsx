...
function AcademicDcbReportHeader() {
  ...
  const handleFetchReport = () => {
    ...
    if (location.pathname === "/academic-detailed-dcb-report") {
      dispatch(tryFetchAcademicDetailsDcbData(data));
    }
    if (location.pathname === "/academic-class-wise-dcb-report") {
      dispatch(tryFetchAcademicClassWiseDcbData(data));
    }
    if (location.pathname === "/academic-consolidated-dcb-report") {
      dispatch(tryFetchAcademicConsolidatedDcbData(data));
    }
    if (location.pathname === "/academic-defaulters") {
      dispatch(tryFetchAcademicDefaultersData(data));
    }
  };
  ...
  return (
    <div className="header-items">
      ...
      />
      {location.pathname === "/academic-detailed-dcb-report" ||
      location.pathname === "/academic-class-wise-dcb-report" ||
      location.pathname === "/academic-defaulters" ? (
        <>
          <Select
...
export default AcademicDcbReportHeader;
